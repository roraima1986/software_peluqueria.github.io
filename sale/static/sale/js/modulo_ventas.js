...
globalThis.ventas = new class modulo_ventas{
    ...
    agregar_a_listado(id,codigo,nombre,precio){
        ...
        if  ($this.seleccionados.indexOf(id)!== -1 ){
            ...
            <style>
                ...
                <tr>
                    <td>
                        <input type='text' readonly name='nombre_prod' value='${codigo}' class='input_text'>                </td>
                    <td>
                        <input type='text' readonly name='nombre_prod' value='${nombre}' class='input_text'>
                    </td>
                    <td>
                        <input type='text' id="cant${id}" readonly name='nombre_prod' value=${$this.cantidad} class='input_text'>
                    </td>
                    <td>
                        <input type='text' readonly name='nombre_prod' value='${precio}' class='input_text'>
                    </td>
                    <td>precio subtotal
                        <input type='text' readonly name='nombre_prod' value='' class='input_text'>
                    </td>
                    <td>
                        <button type="button" onclick="ventas.delete_rows('rows${id}')" class="btn bg-gradient-danger btn-sm" data-toggle="tooltip" data-placement="bottom" title="Quitar">
    ...
    delete_rows(id){
        ...
        console.log('id de la fila y subtotal',id)
        ...
        // Elimina producto del array de productos de la compra
